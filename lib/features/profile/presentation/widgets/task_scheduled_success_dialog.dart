...
class TaskScheduledSuccessDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('TaskScheduledSuccessDialog build() called');
    return Dialog(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                // View My Request Button (minimized)
                SizedBox(
                  width: 120,
  ...
  static void show({
    ...
    print('TaskScheduledSuccessDialog.show called!');
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        return TaskScheduledSuccessDialog(
          taskTitle: taskTitle,
    ...
    print('showDialog call completed');
  }
}
